      ...
      <div className="navbar">
        ...
        <div className="cart-container">
          <a href="#" onClick={handleCartClick}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="68" height="68">
              <circle cx="80" cy="216" r="12"></circle>
              <circle cx="184" cy="216" r="12"></circle>
              <path d="M42.3,72H221.7L195.3,164.4A15.9,15.9,0,0,1,179.9,176H84.1a15.9,15.9,0,0,1-15.4-11.6L32.5,37.8H8" />
            </svg>
          </a>
        </div>
      </div>
